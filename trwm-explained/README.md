...
TRWM (Technique Results Weaknesses Mitigations) is a systematic approach for capturing the details of a digital forensic techqniue *and* then enumerating over its potential weaknesses and mitigations.
